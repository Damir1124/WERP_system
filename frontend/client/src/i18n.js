...
const STRINGS = {
  ...
  specify_address: {
    ru: 'Укажите адрес',
    uz: 'Manzilni belgilang',
    en: 'Specify address',
  },
  address_not_selected_hint: {
    ru: 'Нажмите, чтобы указать, куда привезти заказ',
    uz: 'Buyurtmani qayerga yetkazishni belgilash uchun bosing',
    en: 'Tap to specify where to deliver the order',
  },
  where_delivery: {
    ru: 'Куда привезём заказ',
    uz: 'Buyurtmani qayerga yetkazamiz',
    en: 'Where we deliver the order',
  },
  change_address: {
    ru: 'Изменить',
    uz: "O'zgartirish",
  ...
  send_current_location: {
    ru: 'Отправить текущую локацию',
    uz: 'Joriy joylashuvni yuborish',
